...
describe("type contracts", () => {
  ...
  it("Player has id, position, velocity, and input", () => {
    ...
    const player: Player = { id: "p1", x: 0, y: 0, vx: 0, vy: 0, aimX: 1, aimY: 0, dashCooldownMs: 0, dashCharges: 3, lastDashTimeMs: -1000, chargeMs: 0, heat: 0, enFuegoTimerMs: 0, fakes: 0, parries: 0, input };
  ...
  it("GameState contains ball, players, and score", () => {
    const input: InputState = { moveX: 0, moveY: 0, slap: false, dash: false };
    const p: Player = { id: "host", x: 0, y: 0, vx: 0, vy: 0, aimX: 1, aimY: 0, dashCooldownMs: 0, dashCharges: 3, lastDashTimeMs: -1000, chargeMs: 0, heat: 0, enFuegoTimerMs: 0, fakes: 0, parries: 0, input };
